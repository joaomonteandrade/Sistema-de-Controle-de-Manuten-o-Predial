...
public class LoginView extends javax.swing.JFrame {
    ...
    jTextField1.setPreferredSize(new java.awt.Dimension(360, 20));
    ...
    jPasswordField2.setFont(new java.awt.Font("Poppins", 1, 15)); // NOI18N
    ...
    jPasswordField2.setPreferredSize(new java.awt.Dimension(135, 20));
    ...
    ordem_servico.setLayout(new java.awt.BorderLayout());
    ...
    ordem_servico.add(header, java.awt.BorderLayout.PAGE_START);

    jPanel8.setBackground(new java.awt.Color(255, 51, 0));
    jPanel8.setPreferredSize(new java.awt.Dimension(263, 746));
    ...
    ordem_servico.add(jPanel8, java.awt.BorderLayout.LINE_START);

    root.add(ordem_servico, "ordem_servico");
